...
const View9 = ({ patient,info }) => {
  ...
  const measurePv = () =>{
    ...
    if (a==1 && b==1) {
      if (si==1) {
        return "средней эластичности артерий"
      }
      if (si==2) {
        return "плохой эластичности артерий"
      }      
    }
  }
  return (
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                {info?.ecgRhythm==1 ? info?.ecgRhythmNonSin==1 ? " фибрилляция предсердий" : info?.ecgRhythmNonSin==2 ? " эктопический ритм" : "" : ""}
                </td>
            </tr>
            <tr>
              <td>6</td>
