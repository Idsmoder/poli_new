            ...
            <h6 className="mt-3 fw-bold" style={{ fontSize: "10px" }}>
                ...
                <div className="col-6">
                    ...
                    {!info?.g
                        ...
                        : info?.g === 2
                        ? "Стентирование КА"
                        : "Установка ЭКС или кардиовертера-дефибрилятора"}
                    </p>
                </div>
                <div className="col-6">
                    <p className="m-0 ms-3 my-2" style={{ fontSize: "10px" }}>
                    ...
                    {!info?.h
                        ? ""
                        : info?.h == 1
                        ? "Экстросистолия желудочковая"
                        : info?.h == 2
                        ? "Экстросистолия наджелудочковая"
                        : info?.h == 3
                        ? "Пароксизмальная наджелудочковая тахикардия"
                        : info?.h == 4
                        ? "я блокада правой ножки пучка Гисса"
                        : info?.h == 5
                        ? "Полная блокада левой ножки пучка Гисса"
                        : info?.h == 6
                        ? "Фибрилляция предсердий"
                        : "Другие нарушения рит"}
                    </p>
                </div>
                {/* I */}
                {info?.i ? (
